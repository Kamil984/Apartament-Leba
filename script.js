document.addEventListener("DOMContentLoaded", () => {
  ...
  if (form && thankYouMsg) {
    form.addEventListener("submit", () => {
      setTimeout(() => {
        ...
        }, 5000); // Znikanie po 5 sekundach
      }, 1000); // Pokazanie po 1 sekundzie
    });
  }

  // Pokazanie komunikatu po powrocie z formsubmit
  ...
  // Pokazywanie/ukrywanie kalendarza
...
const images = [
  ...
  "img/19.png", "img/20.png", "img/21.png", "img/22.png", "img/23.png", "img/24.png"
];
